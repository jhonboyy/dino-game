...
import { loadImage, getImageData, randBoolean, randInteger } from "../utils.js";
  ...
  displayStartMessage() {
    ...
    if (isMobile) {
      startMessage.textContent =
        "Ooops, I think you are lost... Tap to find the way.";
    } else {
      startMessage.textContent =
        "Ooops, I think you are lost... Use Space, ↑, or ↓ to find the way.";
    }
